 ...
 * @copyright 2007-2011
  ...
  **/
	...
	require_once WideImage::path() . 'Wide/Exception.php';
	
	require_once WideImage::path() . 'Wide/Image.php';
	require_once WideImage::path() . 'Wide/TrueColorImage.php';
	require_once WideImage::path() . 'Wide/PaletteImage.php';
	
	require_once WideImage::path() . 'Wide/Coordinate.php';
	require_once WideImage::path() . 'Wide/Canvas.php';
	require_once WideImage::path() . 'MapperFactory.php';
	require_once WideImage::path() . 'Wide/OperationFactory.php';
	
	require_once WideImage::path() . 'Wide/Font/TTF.php';
	require_once WideImage::path() . 'Wide/Font/GDF.php';
	require_once WideImage::path() . 'Wide/Font/PS.php';
