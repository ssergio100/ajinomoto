...
class Sincronia extends CI_Controller {
    ...
    public function index() {
        ...
        $output_file = config_item('images_path').$image_name;
        ...
        if($this::saveImg($base64_string, $output_file) === false) {
            ...
            if(count($result) > 0)  die($this->response['message'] ='Esta imagem já foi enviada' );

            $data =  array('nome_md5'=>$md5_image_name, 'nome'=>$image_name, 'image_path' => $output_file);
